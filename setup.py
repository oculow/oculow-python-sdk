...
setup(
  ...
  author_email = 'potosin@live.com',      # Type in your E-Mail
  url = 'https://github.com/oculow/oculow-python-sdk.git',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/user/reponame/archive/v_01.tar.gz',    # I explain this later on
  keywords = ['VISUAL', 'TESTING', 'AI', 'EASY'],   # Keywords that define your package best
  ...
  classifiers=[
    ...
    'License :: OSI Approved :: Apache 2',   # Again, pick a license
